  ...
  return (
    <div id='project' className='md:pl-15 md:pr-15 p-5 md:pb-0 md:pt-10 ' >
      ...
      <div id='firstproject' className="md:hover:border-3 border-1  hover:border-accent w-full h-fit rounded flex flex-col md:flex-row overflow-clip  md:m-5  ">
        ...
        <Button className='rounded text-white bg-accent hover:bg-foreground hover:text-black border-1 ml-3 mt-3'>ReactJS</Button>
        <Button className='rounded text-primary bg-foreground border-1  ml-3 mt-3'>Node.js</Button>
        <Button className='rounded text-white bg-accent hover:bg-foreground hover:text-black border-1 ml-3 mt-3 '>Express</Button>
        <Button className='rounded text-primary bg-foreground border-1 ml-3 mt-3'>MongoDB</Button>
        <Button className='rounded text-white bg-accent hover:bg-foreground hover:text-black border-1 ml-3 mt-3'>JWT</Button>
        <Button className='rounded text-primary bg-foreground border-1 ml-3 mt-3'>Cloudinary</Button>
        <Button className='rounded text-white bg-accent hover:bg-foreground hover:text-black border-1 ml-3 mt-3 '>Tailwind CSS</Button>
        <Button className='rounded text-primary bg-foreground border-1 ml-3 mt-3 '>Vercel</Button>
        <Button className='rounded text-white bg-accent hover:bg-foreground hover:text-black border-1 ml-3 mt-3 '>REST API</Button>
        {/* <Button className='rounded text-white bg-accent hover:bg-foreground hover:text-black border-1 ml-3 mt-3 '>REST API</Button> */}
        ...
        <div id="left" className="w-full md:w-1/2 justify-center align-middle  flex flex-col  p-4"> 
           ...
           <div className=" inline w-full inline-flex flex-row mt-5  justify-center items-center   ">
      ...
      <div id='secondDiv' className="w-full h-fit md:ml-5 flex flex-col md:flex-row ">
          <div className="w-full md:w-1/2 hover:border-1  md:pl-5 md:hover:border-3 md:mr-5 mt-3 md:mt-0 p-4 rounded hover:border-accent  ">
        ...
        <Button className='rounded text-white bg-accent hover:bg-foreground hover:text-black border-1 ml-3 mt-3 '>Express</Button>
        <Button className='rounded text-primary bg-foreground border-1 ml-3 mt-3'>MongoDB</Button>
        <Button className='rounded text-white bg-accent hover:bg-foreground hover:text-black border-1 ml-3 mt-3'>FireBase Auth</Button>
        <Button className='rounded text-primary bg-foreground border-1 ml-3 mt-3'>Cloudinary</Button>
        <Button className='rounded text-white bg-accent hover:bg-foreground hover:text-black border-1 ml-3 mt-3 '>Tailwind CSS</Button>
        <Button className='rounded text-primary bg-foreground border-1 ml-3 mt-3 '>Leaflet Maps</Button>
        <Button className='rounded text-white bg-accent hover:bg-foreground hover:text-black border-1 ml-3 mt-3 '>REST API</Button>
        <a className='text-accent  align-middle inline   ' href="https://tajim-ahmed.github.io/Tradegram/"> <Button className='text-black bg-white  rounded mt-3 md:mt-0  ml-3 ' >🌐 Live Priview </Button> </a> 
          ...
          <div className="w-full md:w-1/2 hover:border-1 md:hover:border-3 p-4 mt-3 md:mt-0 rounded hover:border-accent  ">
        ...
        <Button className='rounded text-white bg-accent hover:bg-foreground hover:text-black border-1 ml-3 mt-3'>HTML5</Button>
        <Button className='rounded text-primary bg-foreground border-1  ml-3 mt-3'>CSS3</Button>
        <Button className='rounded text-white bg-accent hover:bg-foreground hover:text-black border-1 ml-3 mt-3 '>JavaScript (ES6)</Button>
        <Button className='rounded text-primary bg-foreground border-1 ml-3 mt-3'>Responsive Design</Button>
        <Button className='rounded text-white bg-accent hover:bg-foreground hover:text-black border-1 ml-3 mt-3'>Mobile-First UI</Button>
        <Button className='rounded text-primary bg-foreground border-1 ml-3 mt-3'>GitHub Pages</Button>
       ...
       <div id='ThirdDiv' className="md:hover:border-3 mt-3  border-1  hover:border-accent w-full h-fit rounded flex flex-col md:flex-row overflow-clip  md:m-5 mb-0 md:mb-0  ">
        ...
        <Button className='rounded text-white bg-accent hover:bg-foreground hover:text-black border-1 ml-3 mt-3'>Power Apps</Button>
        <Button className='rounded text-primary bg-foreground border-1  ml-3 mt-3'>SharePoint Online</Button>
        <Button className='rounded text-white bg-accent hover:bg-foreground hover:text-black border-1 ml-3 mt-3 '>Power Automate</Button>
        <Button className='rounded text-primary bg-foreground border-1 ml-3 mt-3'>Microsoft 365</Button>
        <Button className='rounded text-white bg-accent hover:bg-foreground hover:text-black border-1 ml-3 mt-3'>Canvas Apps</Button>
        <Button className='rounded text-primary bg-foreground border-1 ml-3 mt-3'>Responsive UI</Button>
        <Button id='Skills' className='rounded text-white bg-accent hover:bg-foreground hover:text-black border-1 ml-3 mt-3 '>Approval Workflow</Button>
        {/* <Button className='rounded text-primary bg-foreground border-1 ml-3 mt-3 '>Vercel</Button>
        <Button className='rounded text-white bg-accent hover:bg-foreground hover:text-black border-1 ml-3 mt-3 '>REST API</Button> */}
        {/* <Button className='rounded text-white bg-accent hover:bg-foreground hover:text-black border-1 ml-3 mt-3 '>REST API</Button> */}
    </div>
